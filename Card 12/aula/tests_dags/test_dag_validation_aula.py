...
class TestDagValidation: #classe de teste pra validar as dags
    LOAD_SECOND_THRESHOLD = 2
    REQUIRED_EMAIL = "owner@test.com"
    EXPECTED_NUMBER_OF_DAGS = 7

    def test_import_dags(self, dagbag): #testa se as dags carregam sem erros
        """
    ...
    def test_time_import_dags(self, dagbag): #testa se as dags carregam rapido o suficiente
        """
    ...
    @pytest.mark.skip(reason="not yet added to the DAGs") #marca o teste como ignorado
    def test_default_args_email(self, dagbag): #testa se as dags tem o email de alerta
        """
    ...
    @pytest.mark.skip(reason="not yet added to the DAGs") #marca o teste como ignorado
    def test_default_args_retries(self, dagbag): #testa se as dags tem o nmr de retries
        """
    ...
    @pytest.mark.skip(reason="not yet added to the DAGs") #marca o teste como ignorado
    def test_default_args_retry_delay(self, dagbag): #teste se as dags tem o retry_delay
        """
    ...
    def test_number_of_dags(self, dagbag): #teste se tem o nmr certo de dags
        """
